...
#define W_KEY_HOLD KEY_HOLD(KEY_TYPE::KEY_W)
#define A_KEY_HOLD KEY_HOLD(KEY_TYPE::KEY_A)
#define S_KEY_HOLD KEY_HOLD(KEY_TYPE::KEY_S)
#define D_KEY_HOLD KEY_HOLD(KEY_TYPE::KEY_D)
