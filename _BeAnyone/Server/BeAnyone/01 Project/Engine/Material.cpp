...
CMaterial::CMaterial()
	...
	, m_bFileSave(true)
{
	m_tParam.m_vDiff = Vector4(0.5f, 0.5f, 0.5f, 0.5f);
	m_tParam.m_vSpec = Vector4(1.f, 1.f, 1.f, 1.f);
	m_tParam.m_vEmv = Vector4(0.f, 0.f, 0.f, 0.f);
}
...
void CMaterial::SetData(SHADER_PARAM _eParam, void* _pData)
{
	...
	case SHADER_PARAM::VEC2_3:
		m_tParam.m_arrVec2[(UINT)_eParam - (UINT)SHADER_PARAM::VEC2_0] = *((Vector2*)_pData);
		break;
	case SHADER_PARAM::VEC4_0:
	case SHADER_PARAM::VEC4_1:
	case SHADER_PARAM::VEC4_2:
	case SHADER_PARAM::VEC4_3:
		m_tParam.m_arrVec4[(UINT)_eParam - (UINT)SHADER_PARAM::VEC4_0] = *((Vector4*)_pData);
		break;
