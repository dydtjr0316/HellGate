...
m_pCurScene->AddGameObject(L"Map", pMapObject, false);
...

	{
		...
		for (int i = 0; i < 2; ++i) {
			...
			z = (int)(72800.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(67900.f + (2400.f * i), 72800.f, bReverseQuad);

			pMapObject->Transform()->SetLocalPos(Vector3(67900.f + (2400.f * i), mapY * 2, 72800.f));
			...
			z = (int)(72500.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(67300.f + (3000.f * i), 72500.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(67300.f + (3000.f * i), mapY * 2, 72500.f));
			pMapObject->Transform()->SetLocalScale(Vector3(200.f, 200.f, 200.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, -XM_PI / 3 + (XM_PI / 2 * i), 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			pMapObject->Collider()->SetColliderType(COLLIDER_TYPE::MESH, L"BigRock_01");
			pMapObject->Collider()->SetBoundingBox(BoundingBox(pMapObject->Transform()->GetLocalPos(), pMapObject->MeshRender()->GetMesh()->GetBoundingBoxExtents(pMapObject->Transform()->GetLocalScale())));
			...
			z = (int)(71500.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(66800.f + (4000.f * i), 71500.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(66800.f + (4000.f * i), mapY * 2, 71500.f));
			pMapObject->Transform()->SetLocalScale(Vector3(200.f, 200.f, 200.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, -XM_PI / 4 + (XM_PI / 2 * i), 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			pMapObject->Collider()->SetColliderType(COLLIDER_TYPE::MESH, L"BigRock_01");
			pMapObject->Collider()->SetBoundingBox(BoundingBox(pMapObject->Transform()->GetLocalPos(), pMapObject->MeshRender()->GetMesh()->GetBoundingBoxExtents(pMapObject->Transform()->GetLocalScale())));
			...
			z = (int)(70500.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(66800.f + (4000.f * i), 70500.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(66800.f + (4000.f * i), mapY * 2, 70500.f));
			pMapObject->Transform()->SetLocalScale(Vector3(200.f, 200.f, 200.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, -XM_PI / 5 + (XM_PI / 2 * i), 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			pMapObject->Collider()->SetColliderType(COLLIDER_TYPE::MESH, L"BigRock_01");
			pMapObject->Collider()->SetBoundingBox(BoundingBox(pMapObject->Transform()->GetLocalPos(), pMapObject->MeshRender()->GetMesh()->GetBoundingBoxExtents(pMapObject->Transform()->GetLocalScale())));
			...
			// 중간 돌
			pMeshData = CResMgr::GetInst()->LoadFBX(L"FBX\\DesertMap\\BigRock_03.fbx", FBX_TYPE::NEW_DESERT_MAP);
			//pMeshData->Save(pMeshData->GetPath());
			pMapObject = nullptr;
			pMapObject = pMeshData->Instantiate();
			pMapObject->SetName(L"BigRock_01");
			...
			z = (int)(70700.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(66500.f + (4600.f * i), 70700.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(66500.f + (4600.f * i), mapY * 2, 70700.f));
			pMapObject->Transform()->SetLocalScale(Vector3(200.f, 200.f, 200.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, -XM_PI / 5 + (XM_PI / 2 * i), 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			...
			z = (int)(72000.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(66600.f + (4400.f * i), 72000.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(66600.f + (4400.f * i), mapY * 2, 72000.f));
			pMapObject->Transform()->SetLocalScale(Vector3(200.f, 200.f, 200.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, XM_PI / 5 + (XM_PI / 2 * i), 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			...
			z = (int)(72550.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(66950.f + (3700.f * i), 72550.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(66950.f + (3700.f * i), mapY * 2, 72550.f));
			pMapObject->Transform()->SetLocalScale(Vector3(200.f, 200.f, 200.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, XM_PI / 4 + (XM_PI / 2 * i), 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			...
			z = (int)(71000.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(66600.f + (4400.f * i), 71000.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(66600.f + (4400.f * i), mapY * 2, 71000.f));
			pMapObject->Transform()->SetLocalScale(Vector3(90.f, 90.f, 90.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, XM_PI / 2 + (XM_PI / 2 * i), 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			pMapObject->Collider()->SetColliderType(COLLIDER_TYPE::MESH, L"Tree");
			pMapObject->Collider()->SetBoundingBox(BoundingBox(pMapObject->Transform()->GetLocalPos(), pMapObject->MeshRender()->GetMesh()->GetBoundingBoxExtents(pMapObject->Transform()->GetLocalScale())));
			...
			z = (int)(71900.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(67000.f + (3600.f * i), 71900.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(67000.f + (3600.f * i), mapY * 2, 71900.f));
			pMapObject->Transform()->SetLocalScale(Vector3(90.f, 90.f, 90.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, XM_PI / 2 + (XM_PI / 2 * i), 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			...
			pMapObject = nullptr;
			pMapObject = pMeshData->Instantiate();
			pMapObject->SetName(L"Stump");
			pMapObject->FrustumCheck(false);
			z = (int)(72100.f / 60.f);
			bReverseQuad = ((z % 2) != 0);
			mapY = _terrain->GetHeight(67200.f, 72100.f, bReverseQuad);
			pMapObject->Transform()->SetLocalPos(Vector3(67200.f, mapY * 2, 72100.f));
			pMapObject->Transform()->SetLocalScale(Vector3(300.f, 300.f, 300.f));//(1.0f, 1.0f, 1.0f));
			pMapObject->Transform()->SetLocalRot(Vector3(-XM_PI / 2, XM_PI / 2, 0.f));
			pMapObject->AddComponent(new CCollider);
			pMapObject->MeshRender()->SetDynamicShadow(true);
			pMapObject->Collider()->SetColliderType(COLLIDER_TYPE::MESH, L"Stump");
			pMapObject->Collider()->SetBoundingBox(BoundingBox(pMapObject->Transform()->GetLocalPos(), pMapObject->MeshRender()->GetMesh()->GetBoundingBoxExtents(pMapObject->Transform()->GetLocalScale())));
			pMapObject->Collider()->SetBoundingSphere(BoundingSphere(pMapObject->Transform()->GetLocalPos(), pMapObject->MeshRender()->GetMesh()->GetBoundingSphereRadius() * 60.f));
			m_pCurScene->AddGameObject(L"Map", pMapObject, false);
		}
